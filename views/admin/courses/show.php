...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
        <button class="btn btn-outline-secondary btn-sm" onclick="document.querySelectorAll('#sectionsAccordion .accordion-collapse').forEach(el => new bootstrap.Collapse(el, {toggle:false}).show())"><i class="fas fa-expand-alt me-1"></i> Expandir Tudo</button>
        <button class="btn btn-outline-secondary btn-sm" onclick="document.querySelectorAll('#sectionsAccordion .accordion-collapse.show').forEach(el => new bootstrap.Collapse(el, {toggle:false}).hide())"><i class="fas fa-compress-alt me-1"></i> Recolher Tudo</button>
...
<?php else: ?>
    <div class="accordion" id="sectionsAccordion">
        ...
        <div class="accordion-item border-0 shadow-sm mb-2">
            ...
            <div id="section<?php echo $section['id']; ?>" class="accordion-collapse collapse <?php echo $i === 0 ? 'show' : ''; ?>">
                <div class="accordion-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <small class="text-muted"><?php echo htmlspecialchars($section['description'] ?? ''); ?></small>
                        <div class="d-flex gap-1">
                            <button class="btn btn-outline-secondary btn-sm" onclick="reorderItem('sections', <?php echo $section['id']; ?>, 'up')" <?php echo $i === 0 ? 'disabled' : ''; ?> title="Mover para cima"><i class="fas fa-arrow-up"></i></button>
                            <button class="btn btn-outline-secondary btn-sm" onclick="reorderItem('sections', <?php echo $section['id']; ?>, 'down')" <?php echo $i === count($sections) - 1 ? 'disabled' : ''; ?> title="Mover para baixo"><i class="fas fa-arrow-down"></i></button>
                    ...
                    <table class="table table-sm table-hover mb-0">
                        ...
                        <tbody>
                            <?php $sLessons = $sectionLessons[$section['id']]; $lessonCount = count($sLessons); ?>
                            <?php foreach ($sLessons as $li => $lesson): ?>
                            <tr>
